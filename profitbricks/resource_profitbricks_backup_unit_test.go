		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("profitbricks_backup_unit.example", "email", "example@profitbricks.com"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckProfitBricksbackupUnitExists("profitbricks_backup_unit.example", &backupUnit),
					resource.TestCheckResourceAttr("profitbricks_backup_unit.example", "email", "example-updated@profitbricks.com"),
