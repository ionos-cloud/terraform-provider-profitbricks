...
func resourcePrivateCrossConnect() *schema.Resource {
	return &schema.Resource{
		...
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudPrivateCrossConnectImport,
		},
...
func privateCrossConnectReady(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
...
func privateCrossConnectDeleted(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
