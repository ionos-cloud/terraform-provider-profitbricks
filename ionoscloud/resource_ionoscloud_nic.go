...
func resourceIonosCloudNic() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudNicCreate,
		Read:   resourceIonosCloudNicRead,
		Update: resourceIonosCloudNicUpdate,
		Delete: resourceIonosCloudNicDelete,
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudNicImport,
		},
...
func resourceIonosCloudNicCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudNicRead(d, meta)
}

func resourceIonosCloudNicRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudNicUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	properties := ionoscloud.NicProperties{}
...
func resourceIonosCloudNicDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
