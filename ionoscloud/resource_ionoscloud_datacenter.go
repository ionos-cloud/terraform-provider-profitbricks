...
func resourceIonosCloudDatacenter() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudDatacenterCreate,
		Read:   resourceIonosCloudDatacenterRead,
		Update: resourceIonosCloudDatacenterUpdate,
		Delete: resourceIonosCloudDatacenterDelete,
...
func resourceIonosCloudDatacenterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudDatacenterRead(d, meta)
}

func resourceIonosCloudDatacenterRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudDatacenterUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudDatacenterDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcid := d.Id()
...
func getImage(client *ionoscloud.Client, dcId string, imageName string, imageType string) (*ionoscloud.Image, error) {
	if imageName == "" {
...
func getSnapshotId(client *ionoscloud.Client, snapshotName string) string {
	if snapshotName == "" {
		return ""
	}
...
func getImageAlias(client *ionoscloud.Client, imageAlias string, location string) string {
	if imageAlias == "" {
		return ""
	}
