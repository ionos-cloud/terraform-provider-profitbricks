...
func resourceIonosCloudGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudGroupCreate,
		Read:   resourceIonosCloudGroupRead,
		Update: resourceIonosCloudGroupUpdate,
		Delete: resourceIonosCloudGroupDelete,
...
func resourceIonosCloudGroupCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudGroupRead(d, meta)
}

func resourceIonosCloudGroupRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudGroupUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	tempCreateDataCenter := d.Get("create_datacenter").(bool)
	tempCreateSnapshot := d.Get("create_snapshot").(bool)
	tempReserveIp := d.Get("reserve_ip").(bool)
...
func resourceIonosCloudGroupDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
