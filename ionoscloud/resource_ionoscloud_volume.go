...
func resourceIonosCloudVolume() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudVolumeCreate,
		Read:   resourceIonosCloudVolumeRead,
		Update: resourceIonosCloudVolumeUpdate,
		Delete: resourceIonosCloudVolumeDelete,
...
func resourceIonosCloudVolumeCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudVolumeRead(d, meta)
}

func resourceIonosCloudVolumeRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcId := d.Get("datacenter_id").(string)
	serverID := d.Get("server_id").(string)
	volumeID := d.Id()
...
func resourceIonosCloudVolumeUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	properties := ionoscloud.VolumeProperties{}
	dcId := d.Get("datacenter_id").(string)
...
func resourceIonosCloudVolumeDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcId := d.Get("datacenter_id").(string)
