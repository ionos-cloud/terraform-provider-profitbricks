...
func resourceIonosCloudUser() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudUserCreate,
		Read:   resourceIonosCloudUserRead,
		Update: resourceIonosCloudUserUpdate,
		Delete: resourceIonosCloudUserDelete,
...
func resourceIonosCloudUserCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudUserRead(d, meta)
}

func resourceIonosCloudUserRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudUserUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudUserDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
