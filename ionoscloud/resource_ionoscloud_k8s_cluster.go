...
func resourcek8sCluster() *schema.Resource {
	return &schema.Resource{
		...
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudK8sClusterImport,
		},
...
func resourcek8sClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if _, mwOk := d.GetOk("maintenance_window.0"); mwOk {
		cluster.Properties.MaintenanceWindow = &ionoscloud.MaintenanceWindow{}
	}
...
func resourcek8sClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	request := ionoscloud.UpdatedKubernetesCluster{}
...
func k8sClusterReady(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
...
func k8sClusterDeleted(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
