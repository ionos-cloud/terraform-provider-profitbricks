...
func resourceIonosCloudLan() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudLanCreate,
		Read:   resourceIonosCloudLanRead,
		Update: resourceIonosCloudLanUpdate,
		Delete: resourceIonosCloudLanDelete,
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudResourceImport,
		},
...
func resourceIonosCloudLanCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudLanRead(d, meta)
}

func resourceIonosCloudLanRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudLanUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	properties := &ionoscloud.LanProperties{}
...
func resourceIonosCloudLanDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func lanAvailable(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
...
func lanDeleted(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
	subjectLAN, err := client.GetLan(d.Get("datacenter_id").(string), d.Id())
