...
func resourceIonosCloudServer() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudServerCreate,
		Read:   resourceIonosCloudServerRead,
		Update: resourceIonosCloudServerUpdate,
		Delete: resourceIonosCloudServerDelete,
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudServerImport,
		},
...
func resourceIonosCloudServerCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if !IsValidUUID(image_name) {
		...
		apiError, rsp := err.(ionoscloud.ApiError)
	...
	return resourceIonosCloudServerRead(d, meta)
}
...
func resourceIonosCloudServerRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcId := d.Get("datacenter_id").(string)
	serverId := d.Id()
...
func resourceIonosCloudServerUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcId := d.Get("datacenter_id").(string)
...
func resourceIonosCloudServerDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcId := d.Get("datacenter_id").(string)
