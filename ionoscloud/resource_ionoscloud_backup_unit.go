...
func resourceBackupUnit() *schema.Resource {
	return &schema.Resource{
		...
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudBackupUnitImport,
		},
...
func backupUnitReady(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
...
func backupUnitDeleted(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
