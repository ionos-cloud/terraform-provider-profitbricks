...
func resourceIonosCloudResourceImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
...
func resourceIonosCloudServerImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	parts := strings.Split(d.Id(), "/")
...
func resourceIonosCloudK8sClusterImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
...
func resourceIonosCloudK8sNodepoolImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
...
func resourceIonosCloudPrivateCrossConnectImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudBackupUnitImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudS3KeyImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	parts := strings.Split(d.Id(), "/")
...
func resourceIonosCloudFirewallImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	parts := strings.Split(d.Id(), "/")
...
func resourceIonosCloudNicImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	parts := strings.Split(d.Id(), "/")
