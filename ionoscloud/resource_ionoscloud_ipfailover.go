...
func resourceIonosCloudLanIPFailover() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudLanIPFailoverCreate,
		Read:   resourceIonosCloudLanIPFailoverRead,
		Update: resourceIonosCloudLanIPFailoverUpdate,
		Delete: resourceIonosCloudLanIPFailoverDelete,
...
func resourceIonosCloudLanIPFailoverCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudLanIPFailoverRead(d, meta)
}

func resourceIonosCloudLanIPFailoverRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudLanIPFailoverUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	properties := &ionoscloud.LanProperties{}
	dcid := d.Get("datacenter_id").(string)
	lanid := d.Get("lan_id").(string)
...
func resourceIonosCloudLanIPFailoverDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	dcid := d.Get("datacenter_id").(string)
	lanid := d.Get("lan_id").(string)
