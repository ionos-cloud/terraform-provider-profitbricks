...
func Provider() terraform.ResourceProvider {
	provider := &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			"ionoscloud_datacenter":           resourceIonosCloudDatacenter(),
			"ionoscloud_ipblock":              resourceIonosCloudIPBlock(),
			"ionoscloud_firewall":             resourceIonosCloudFirewall(),
			"ionoscloud_lan":                  resourceIonosCloudLan(),
			"ionoscloud_loadbalancer":         resourceIonosCloudLoadbalancer(),
			"ionoscloud_nic":                  resourceIonosCloudNic(),
			"ionoscloud_server":               resourceIonosCloudServer(),
			"ionoscloud_volume":               resourceIonosCloudVolume(),
			"ionoscloud_group":                resourceIonosCloudGroup(),
			"ionoscloud_share":                resourceIonosCloudShare(),
			"ionoscloud_user":                 resourceIonosCloudUser(),
			"ionoscloud_snapshot":             resourceIonosCloudSnapshot(),
			"ionoscloud_ipfailover":           resourceIonosCloudLanIPFailover(),
