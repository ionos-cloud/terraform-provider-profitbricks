...
func resourceIonosCloudFirewall() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudFirewallCreate,
		Read:   resourceIonosCloudFirewallRead,
		Update: resourceIonosCloudFirewallUpdate,
		Delete: resourceIonosCloudFirewallDelete,
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudFirewallImport,
		},
...
func resourceIonosCloudFirewallCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudFirewallRead(d, meta)
}

func resourceIonosCloudFirewallRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudFirewallUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
	properties := ionoscloud.FirewallruleProperties{}
...
func resourceIonosCloudFirewallDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
