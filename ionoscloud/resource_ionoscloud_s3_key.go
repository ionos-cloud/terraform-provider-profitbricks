...
func resourceS3Key() *schema.Resource {
	return &schema.Resource{
		...
		Importer: &schema.ResourceImporter{
			State: resourceIonosCloudS3KeyImport,
		},
...
func s3KeyDeleted(client *ionoscloud.Client, d *schema.ResourceData) (bool, error) {
...
func s3Ready(client *ionoscloud.Client, d *schema.ResourceData, s3Key *ionoscloud.S3Key) (bool, error) {
