...
func resourceIonosCloudIPBlock() *schema.Resource {
	return &schema.Resource{
		Create: resourceIonosCloudIPBlockCreate,
		Read:   resourceIonosCloudIPBlockRead,
		Update: resourceIonosCloudIPBlockUpdate,
		Delete: resourceIonosCloudIPBlockDelete,
...
func resourceIonosCloudIPBlockCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceIonosCloudIPBlockRead(d, meta)
}

func resourceIonosCloudIPBlockRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudIPBlockUpdate(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
...
func resourceIonosCloudIPBlockDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ionoscloud.Client)
